...
def get_random_string(length):
    ...
    print(Fore.WHITE + "[" + Fore.CYAN + "M1000 CC" + Fore.WHITE + "]" + "  CC NO: " + Fore.LIGHTRED_EX + result_str + "-" + son_str + "-" + cvv_str + Fore.WHITE + "  [" + "SONUÇ: " + Fore.RED + "0.00 ORAN" + Fore.WHITE + "]")
...
def get_random_win(length):
    print(Fore.WHITE + "[" + Fore.CYAN + "M1000 CC" + Fore.WHITE + "]" + "  CC NO: " + Fore.LIGHTGREEN_EX + str(heheha) +"-"+son_str+"-"+cvv_str+ Fore.WHITE + "  [" + "SONUÇ: " + Fore.GREEN + str(winner) + " ORAN" + Fore.WHITE + "]")
    ...
    for i in range(20):
        ...
        sys.stdout.flush()
    print(Fore.WHITE + "[" + Fore.CYAN +"M1000 CC" + Fore.WHITE + "]" + "  CC NO: " + Fore.LIGHTGREEN_EX + "5319 2518 1638 5726  - 06/27 - 587"+ Fore.WHITE + "  [" + "SONUÇ: " + Fore.GREEN + str(winner) + "  ORAN" + Fore.WHITE + "]")
...
print("")
time.sleep(1)
print(Fore.WHITE + "[" + Fore.CYAN + "M1000 CC" + Fore.WHITE + "]" + Fore.LIGHTGREEN_EX + "CC BİLGİLERİ KAYDEDİLDİ KAYDEDİLDİ" + Fore.WHITE + "  [" + "SONUÇ: " + Fore.GREEN + "SUCCESS" + Fore.WHITE + "]") 
time.sleep(1)
